...
class SearchBooksFailureState extends SearchBooksState {
  final String errorMessageVerticalSearchState;
  SearchBooksFailureState({
    required this.errorMessageVerticalSearchState,
  });
}

class SearchBooksSuccessState extends SearchBooksState {
  final List<BookModel> booksVerticalSearchState;
  SearchBooksSuccessState({
    required this.booksVerticalSearchState,
  });
}
